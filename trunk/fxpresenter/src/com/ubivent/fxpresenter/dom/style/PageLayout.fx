...
public class PageLayout extends PElement {
    init {
        nsURI = nsSTYLE;
        nodeName = "style:page-layout";
    }

    public function getPLProperties() : PageLayoutProperties {
        return getElementsByTagNameNS(nsSTYLE, "page-layout-properties")[0] as PageLayoutProperties;
    }
}
